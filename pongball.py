...
#Comments
# 1) Fix Paddle going out of border.
# 2) How to increase the speed of turtle module.
# 3) Find Answer to "Logic behing movement and momentum of ball" why it goes left right left right.
# 4) Pen Up Pen Down 
# 5) Add SFX 
